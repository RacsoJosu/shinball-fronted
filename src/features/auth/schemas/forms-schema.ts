...
export const formUserFieldSchema = z.object({
  firstName: z
    .string()
...
export const signUpSchema = formUserFieldSchema.and(
  passwordSchema.refine((data) => data.password === data.passwordConfirmation, {
